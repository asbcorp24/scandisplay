...
$path = realpath($uploadDir . DIRECTORY_SEPARATOR . $recording['file_path']);
...
$sourceName = (string) ($recording['original_name'] ?: $recording['title'] . '.mp4');
$inlineName = preg_replace('/[^\pL\pN._-]+/u', '_', $sourceName) ?: 'recording.mp4';
header("Content-Disposition: inline; filename*=UTF-8''" . rawurlencode($inlineName));
